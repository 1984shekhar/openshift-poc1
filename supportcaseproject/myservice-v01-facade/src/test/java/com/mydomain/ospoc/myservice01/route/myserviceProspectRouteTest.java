 ...
 */
public class myserviceProspectRouteTest extends CamelBlueprintTestSupport {

    private static final Logger LOG = LogManager.getLogger(myserviceProspectRouteTest.class);
    static final String BLUEPRINT_DESCRIPTOR = "OSGI-INF/blueprint/blueprint.xml";
    static final String CONFIG_PATH = "mydomain.common.cfg";
    ...
    protected Properties useOverridePropertiesWithPropertiesComponent() {
        ...
        try {
            properties.load(getClass().getClassLoader().getResourceAsStream("mydomain.common.cfg"));
        } catch (IOException e) {
...
//                replaceFromWith("direct:start");
        ...
        template.send("http://localhost:8080/myservice01/v01/prospects/123", exchange);
